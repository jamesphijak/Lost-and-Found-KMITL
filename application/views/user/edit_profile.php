                ...
                <!-- Form input -->
                    <div class='form-group col-md-6'>
                        ...
                        <div class='form-group col-md-12'>
                            ...
                            <input readonly type='text' name='email' value="<?= set_value('email',$user->user_email) ?>" class='form-control' placeholder='โปรดกรอกอีเมล' />
                            <small class="text-danger"><b><?= form_error('email')?></b></small>
                        </div>
                        <div class='form-group col-md-12'>
                            <label class='col-form-label'>เบอร์โทรศัพท์</label>
                            <input type='text' name='mobile' value="<?= set_value('mobile',$user->user_mobile) ?>" class='form-control' placeholder='โปรดกรอกเบอร์โทรศัพท์' />
